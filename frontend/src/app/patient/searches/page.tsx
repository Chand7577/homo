  ...
  const DoctorCard = ({ doctor, featured = false }) => {
    ...
    return (
      ...
      >
        {/* Header */}
        <div
          className={`relative h-28 bg-gradient-to-br ${badge.gradient} p-5`}
        >
          {featured && (
          ...
          <div className="absolute top-3 right-3">
            <div
              className={`bg-white px-3 py-1.5 rounded-full flex items-center gap-1.5 ${badge.border} border`}
            >
              {badge.icon}
        ...
        {currentStep === 2 && (
          <div>
            ...
            {loading ? (
              ...
              <>
                {/* Dr. JP Nautiyal - Premium Section (FIXED RESPONSIVE) */}
                {jpNautiyalDoctors.length > 0 && (
                  <div className="mb-12">
                    ...
                    {jpNautiyalDoctors.map((doctor) => (
                      ...
                      >
                        {/* FIXED: Responsive Header Banner */}
                        <div className="relative h-24 md:h-32 bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-600 p-4 md:p-6">
                          ...
                          <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                            <div className="flex flex-wrap items-center gap-2">
                              <div className="flex items-center gap-1.5 md:gap-2 bg-white/20 backdrop-blur-sm px-2 md:px-4 py-1.5 md:py-2 rounded-full border border-white/30">
                                <Shield className="w-3 h-3 md:w-5 md:h-5 text-white" />
                                <span className="text-white font-bold text-xs md:text-sm">
                                  SYSTEM DEFAULT
                                </span>
                              </div>
                              <div className="flex items-center gap-1.5 md:gap-2 bg-yellow-400/90 px-2 md:px-4 py-1.5 md:py-2 rounded-full">
